...
function buyBaseInput({
  ...
  const {
    ...
    feeConfig,
    creator,
    baseMintSupply: new BN5(baseMintAccount.supply.toString()),
    baseMint,
    baseReserve,
    quoteReserve,
  ...
  const coinCreatorFee = PublicKey2.default.equals(coinCreator) ? new BN5(0) : fee(quoteAmountIn, coinCreatorFeeBps);
...
function buyQuoteInput({
  ...
  const totalFeeBps = lpFeeBps.add(protocolFeeBps).add(PublicKey2.default.equals(coinCreator) ? new BN5(0) : coinCreatorFeeBps);
...
function sellBaseInput({
  ...
  const coinCreatorFee = PublicKey3.default.equals(coinCreator) ? new BN6(0) : fee(quoteAmountOut, coinCreatorFeeBps);
...
function sellQuoteInput({
  ...
  const rawQuote = calculateQuoteAmountOut(
    ...
    lpFeeBps,
    protocolFeeBps,
    PublicKey3.default.equals(coinCreator) ? new BN6(0) : coinCreatorFeeBps
  );
